  ...
  return (
    <>
      ...
      >
        ...
        {/* Banner Image */}
        <div className="relative w-full h-48 sm:h-56 md:h-72 mb-10 mt-20 sm:mb-14 overflow-hidden rounded-3xl shadow-2xl shadow-purple-500/10">
          <Image
            src={Banner}
            alt="Projects Banner"
            fill
                  ...
                  <div className="relative [backface-visibility:hidden] flex flex-col">
                    ...
                    <div className="p-5 flex flex-col">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <ArrowUpRight
                          size={16}
                          className="text-muted-foreground group-hover:text-purple-500 transition-colors shrink-0 mt-1"
                        />
                      </div>
                      ...
                      <div className="mt-4 flex gap-2">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl text-white text-xs font-semibold shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 active:scale-95"
                        >
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-xl border border-gray-200text-foreground bg-white/50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:scale-105 active:scale-95"
