...
export default function NotFound() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-6">
      ...
      <div className="absolute left-1/2 top-1/2 h-[450px] w-[450px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-background/5 blur-[150px]" />
      ...
      <div className="relative z-10 max-w-3xl text-center">
        ...
        <div className="mt-20 flex items-center justify-center gap-3">
          ...
          <div className="h-2 w-2 rounded-full bg-foreground/70 animate-pulse delay-150" />
          <div className="h-2 w-2 rounded-full bg-foreground/40 animate-pulse delay-300" />
        </div>
